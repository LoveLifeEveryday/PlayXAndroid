 ...
 * @Description SoftInputHelper 监听软键盘的打开和隐藏 打开时滚动布局，可设置仅在某几个EditText获取焦点时开启
 */
...
public final class SoftInputHelper implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnGlobalFocusChangeListener {
    ...
    private Runnable moveRunnable = this::calcToMove;
    ...
    public void moveWith(View bottomView, View... focusViews) {
